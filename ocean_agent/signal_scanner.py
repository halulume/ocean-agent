...
#   1.0배 905건 중 56건(6.2%)  ·  2.0배 1,294건 중 23건(1.8%)
#   3.0배 1,294건 중 23건(1.8%) — 거래·청산사유가 2.0배와 완전히 동일
...
#
# 근거로 쓰지 않는 것: 08-09 하네스 스윕((재생 스윕 결과는 인과성 버그로 무효, 내부 문서 참조)
# 버그(검토 B5)로 무효다. 진입 이전 가격에 익절이 체결돼 수익이 허수였다.
# 수정 후 최종자본은 1.0×$1,256 / 2.0×$1,047 / 3.0×$1,055 로 전부 잡음
